...
class ProfileSerializer(serializers.Serializer): #viewing and editing profile
...
class ProfileListSerializer(serializers.Serializer): #listing all family members
    member = serializers.SerializerMethodField()
