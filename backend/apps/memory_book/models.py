...
class MemoryItem(models.Model):
    ...
    def __str__(self):
        return f"{self.get_item_type_display()} by {self.uploaded_by.full_name}"
...
class MemoryDeletionRequest(models.Model):
    ...
    class Meta:
        ordering = ['-created_at']
        verbose_name = "Memory Deletion Request"
        verbose_name_plural = "Memory Deletion Requests"
